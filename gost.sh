...
main_menu() {
    while true; do
        clear
        echo -e "\033[1;32mProtocols:\033[0m SSH,h2,gRPC,WSS,WS,QUIC,KCP,TLS,MWSS,H2C,OBFS4,OHTTP,OTLS,MTL "
        ...
        echo -e " \033[1;34m3.\033[0m rely+Protocols mode (multi-port) "
        echo -e " \033[1;34m4.\033[0m forward+Protocols mode (single port) "
