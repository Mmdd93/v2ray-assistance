...
# Function to create a gre tunnel
create_gre_tunnel() {
source /root/ipv4.txt
...
manage_tunnels() {
    ...
    # Get all active gre tunnel services from both directories
...
# Save the configuration to /root/gre/$selected_tunnel.txt
...
# Download the auto_gre_update.sh script to /root
echo -e "${CYAN}Downloading the auto_gre_update.sh script...${RESET}"
curl -sL https://raw.githubusercontent.com/Mmdd93/v2ray-assistance/main/auto_gre_update.sh -o /root/auto_gre_update.sh

# Make the downloaded script executable
chmod +x /root/auto_gre_update.sh

echo -e "${greEN}auto_gre_update.sh downloaded and made executable!${RESET}"

# Default interval for auto_gre_update.sh in minutes
default_update_interval_min=5

# Prompt user for auto_gre_update.sh run interval in minutes
...
auto_gre_update_script="/root/auto_gre_update.sh"

# Validate the existence of the script
if [[ ! -f "$auto_gre_update_script" ]]; then
    echo -e "\033[1;31mError: The script $auto_gre_update_script does not exist.\033[0m"
    return 1
fi

# Overwrite the existing cron job for auto_gre_update.sh
(crontab -l 2>/dev/null | grep -v "$auto_gre_update_script"; echo "$cron_schedule $auto_gre_update_script") | crontab - || {
    echo -e "\033[1;31mFailed to set cron job for auto_gre_update.sh.\033[0m"
    return 1
}
...
sleep 1
echo -e "\033[1;32mauto_gre_update.sh will now run every $update_minutes minute(s).\033[0m"
...
echo -e "\033[1;34m=========================================\033[0m"
echo -e "\033[1;36m 1.\033[0m \033[1;32mCreate gre Tunnel\033[0m"
echo -e "\033[1;36m 2.\033[0m \033[1;32mManage gre Tunnels\033[0m"
echo -e "\033[1;36m 3.\033[0m \033[1;32mStart all gre Tunnels\033[0m"
echo -e "\033[1;36m 4.\033[0m \033[1;32mStop all gre Tunnels\033[0m"
echo -e "\033[1;36m 5.\033[0m \033[1;32mRestart all gre Tunnels\033[0m"
echo -e "\033[1;36m 6.\033[0m \033[1;32mBackup all gre Tunnels\033[0m"
echo -e "\033[1;36m 7.\033[0m \033[1;32mTransfer all gre tunnels to another server\033[0m"
