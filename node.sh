...
main_menu() {
    while true; do
        ...
        echo -e "${LIGHT_GREEN}  9.${NC} ${GREEN}Speed test and benchmark${NC}"
        echo -e "${LIGHT_GREEN} 10.${NC} ${GREEN}Port management (in-use ports, connected IPs)${NC}"
        echo -e "${LIGHT_GREEN} 11.${NC} ${GREEN}Auto clear cache and server reboot${NC}"
        echo -e "${LIGHT_GREEN} 12.${NC} ${GREEN}Ping management (enable/disable)${NC}"
        echo -e "${LIGHT_GREEN} 13.${NC} ${GREEN}Change server DNS${NC}"
        echo -e "${LIGHT_GREEN} 14.${NC} ${GREEN}Create personal DNS${NC}"
        echo -e "${LIGHT_GREEN} 15.${NC} ${GREEN}SSL certificate management${NC}"
        echo -e "${LIGHT_GREEN} 16.${NC} ${GREEN}SWAP management${NC}"
        echo -e "${LIGHT_GREEN} 17.${NC} ${GREEN}Desktop + Firefox on Ubuntu server${NC}"
        echo -e "${LIGHT_GREEN} 18.${NC} ${GREEN}Server monthly traffic limit${NC}"
        echo -e "${LIGHT_GREEN} 19.${NC} ${GREEN}CPU/RAM monitoring${NC}"
        echo -e "${LIGHT_GREEN} 20.${NC} ${GREEN}UFW firewall management${NC}"
        echo -e "${LIGHT_GREEN} 21.${NC} ${GREEN}Cloudflare auto IP changer${NC}"
        echo -e "${LIGHT_GREEN} 22.${NC} ${GREEN}IP quality checks${NC}"
        echo -e "${LIGHT_GREEN} 23.${NC} ${GREEN}Nginx management${NC}"
        echo -e "${LIGHT_GREEN} 24.${NC} ${GREEN}IPv6 management (enable/disable)${NC}"
        echo -e "${LIGHT_GREEN} 25.${NC} ${GREEN}ZRAM optimization${NC}"
        echo -e "${LIGHT_GREEN} 29.${NC} ${GREEN}Send file to remote server & Telegram${NC}"
        echo -e "${LIGHT_GREEN} 30.${NC} ${GREEN}Auto check URLs${NC}"
        echo -e "${LIGHT_GREEN} 32.${NC} ${GREEN}Change timezone (Fix WhatsApp time)${NC}"
        echo -e "${LIGHT_GREEN} 33.${NC} ${GREEN}Secure SSH (fail2ban)${NC}"
        echo -e "${LIGHT_GREEN} 34.${NC} ${GREEN}Block torrent traffic${NC}"
        echo -e "${LIGHT_GREEN} 35.${NC} ${GREEN}AWS CLI installation${NC}"
        echo -e "${LIGHT_GREEN} 36.${NC} ${GREEN}Cron job management${NC}"
        echo -e "${LIGHT_GREEN} 37.${NC} ${GREEN}File management tools${NC}"
        echo -e "${LIGHT_GREEN} 71.${NC} ${GREEN}Abuse Defender (Hetzner)${NC}"
        echo
